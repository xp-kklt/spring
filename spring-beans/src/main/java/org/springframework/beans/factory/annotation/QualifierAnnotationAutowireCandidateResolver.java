...
public class QualifierAnnotationAutowireCandidateResolver extends GenericTypeAwareAutowireCandidateResolver {
	 ...
	 * 此外，如果此 bean 工厂将要自动装配的字段或参数上的注解识别为 @qualifier，
	 * 则 bean 必须“匹配”该注解及其可能包含的任何属性。
	 * bd 必须包含相同的限定符或按元属性匹配。
	 * 如果限定符或属性不匹配，“value”属性将回退以匹配 bean 的name或别名。
	 *
	 * @Qualifier("x") ：直接匹配x,不匹配y了。
	 * <p>
