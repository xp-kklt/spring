...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/**
	 * beanDefinition的持有者，BeanDefinitionHolder持有了一个beanDefinition对象和别名
	 */
	@Nullable
	...
	/**
	 * 注册一个正在被这个 bd 修饰的目标bd。
	 * 相当于目标bd存放在decoratedDefinition
