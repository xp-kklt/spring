...
public @interface Scope {
	...
	/**
	 * 指定是否应将组件配置为作用域代理scoped proxy，如果是，则代理应基于接口还是基于子类。
	 * 默认为 {@link ScopedProxyMode#DEFAULT}，
	 * 这通常表示除非在组件扫描指令级别配置了不同的默认值，否则不应创建scoped proxy。
	 * <p>
	 ...
	 * <p>Analogous类似的 to {@code <aop:scoped-proxy/>} support in Spring XML.
	 *
	 * @see ScopedProxyMode
	 */
