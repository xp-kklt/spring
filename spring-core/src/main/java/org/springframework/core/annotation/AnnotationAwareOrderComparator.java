...
/**
 * {@code AnnotationAwareOrderComparator} 是
 * {@link OrderComparator} 的扩展，
 * 支持 Spring 的 {@link org.springframework.core.Ordered} 接口
 * 以及 {@link Order @Order} 和 {@link javax.annotation.Priority @ Priority} 注解，
 * 由 {@code Ordered} 实例提供的顺序值覆盖静态定义的注释值（如果有）。
 * <p>
