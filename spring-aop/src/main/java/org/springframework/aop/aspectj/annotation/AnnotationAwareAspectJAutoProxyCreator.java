...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {
	...
	protected boolean isInfrastructureClass(Class<?> beanClass) {
		...
		//
		// 以前我们在构造函数中 setProxyTargetClass(true)，但这影响太广泛了。
		// 相反，我们现在继承 isInfrastructureClass方法 以避免代理方面。？？？？？？？？？？？？？？？怎么翻译
		//
		// 判断是不是基础类，比如继承自Advice，Pointcut，Advisor，AopInfrastructureBean的类，
		// 或者代理工厂不为null并且该类是一个切面，比如我们实现的NotVeryUseFullAspect这个类就是一个切面，它有@Aspect
